...
export const OWNER = process.env.GITHUB_OWNER || "kieuchinh3007-star";
export const REPO = process.env.GITHUB_REPO || "htx-mkt-xipat";
...
export const COMMITTER_EMAIL = process.env.GIT_COMMITTER_EMAIL || "bot@htx-mkt-xipat.local";
